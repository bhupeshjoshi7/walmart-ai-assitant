        ...
        <Wrapper className="chat  flex flex-col flex-1 h-full  bg-gray-100">
            <div className="flex sm:items-center justify-between p-3  border-b-2 border-gray-200">
                ...
                <div className="flex items-center space-x-2">
                    <button type="button" className="inline-flex items-center mr-2 justify-center rounded-full h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none" onClick={() => {
                        props.closeMessage()
                    }}>
                        <XIcon className="p-1" />
                    </button>
